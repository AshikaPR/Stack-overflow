  ...
  return (
    <section className='auth-section'>
        ...
        <div className='auth-container-2'>
            {!isSignUp && <img src={icon} alt='stack overflow' className='logo-icon'/>}
            ...
            <form onSubmit = {handleSubmit}>
                ...
                <div style={{display: 'flex', justifyContent: 'space-between'}}>
                    ...
                    {isSignUp && <p style={{color: '#666767', fontSize: '13px'}}>Password must contain atleast 8 characters<br/> including atleast 1 letter and 1 number.</p>}
                </label>
